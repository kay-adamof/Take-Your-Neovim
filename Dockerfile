...
RUN git clone https://github.com/AstroNvim/AstroNvim ~/.config/nvim && nvim --headless -c 'autocmd User PackerComplete quitall' && nvim --headless -c 'TSUpdateSync lua vim' -c 'qa'
ENV ENV LANG en_US.UTF-8  
ENV LANGUAGE en_US:en  
ENV LC_ALL en_US.UTF-8
